...
export default class AdditionScreen3 extends Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      ...
      value1: Math.floor(Math.random() * 90) + 10,
      value2: Math.floor(Math.random() * 90) + 10,
    };
  }
  ...
  check = () => {
    ...
    if (answer == value1 + value2) {
      ...
      this.setState({
        value1: Math.floor(Math.random() * 900) + 10,
        value2: Math.floor(Math.random() * 900) + 10,
        questionNumber: this.state.questionNumber + 1,
